...
const YOUTUBE_API_KEY = "AIzaSyDQ0Kiwc2Yn3jXAY4XdZihEVXFiRDzV2z8";
async function fetchVideo() {
  const video = await fetch(
    `${YOUTUBE_PLAYLIST_ITEMS_API}?part=snippet&playlistId=PLbJn9Lzkmk4Q039f0amBPG0W1T9c708xq&maxResults=6&key=${YOUTUBE_API_KEY}`,
    {
      cache: "no-store",
    }
  );
...
export default async function EXPLORE() {
  ...
  return (
    <section id="popular" className="explorer-wrapper mt-8 py-4  px-7 sm:px-12">
